...
certutil -f -addstore Root "%~dp0certs\root.cer"
...
%cscript% /nologo %capicompath% import -l LM "%~dp0..\..\certs\Assets\IdentityTKStsCert.pfx" "IdentityTKStsCert"
certutil -f -addstore TrustedPeople "%~dp0..\..\Assets\certs\IdentityTKStsCert.cer"
...
@if "%IsW7%" == "true" (
	"%~dp0winhttpcertcfg.exe" -g -c LOCAL_MACHINE\My -s localhost -a "IIS_IUSRS" 2> nul
	"%~dp0winhttpcertcfg.exe" -g -c LOCAL_MACHINE\My -s IdentityTKStsCert -a "IIS_IUSRS" 2> nul
