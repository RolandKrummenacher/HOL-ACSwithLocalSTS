...
DEL "%MyDocuments%\Visual Studio 2010\Code Snippets\Visual C#\My Code Snippets\ACSwithLocalSTS*.snippet" 2>NUL
DEL "%MyDocuments%\Visual Studio 2010\Code Snippets\XML\My Xml Snippets\ACSwithLocalSTS*.snippet" 2>NUL
